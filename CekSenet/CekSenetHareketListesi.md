...
- Sol sekmede Aaro kullanýcý bilgilerinin hemen altýnda yer alan arama motorundan "Çek/Senet hareket listesi" aratarak ulaþým saðlayabilirsiniz.
- Sol menüden Çek/Senet -> Modül Sayfasý -> Çek/Senet Hareketleri Listesi üzerinden ulaþým saðlayabilirsiniz. 
- Sol menüden Çek/Senet -> Listeler -> Çek/Senet Hareketleri Listesi üzerinden ulaþým saðlayabilirsiniz.

### Taným 

- Çek/Senet kartlarýnýn hareketlerini bu sayfadan görüntüleyebilirsiniz.
- Çek/Senet kartlarýnýn güncel ve belirli bir tarihte ki bakiyelerini görüntüleyebilirsiniz.
