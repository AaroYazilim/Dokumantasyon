...
[Reçete](/Uretim/Recete.md "Reçete") bir ürünün yapýmýnda kullanýlan malzemenin ve bu malzemlerin hangi oranlarda ve nasýl kullanýlacaðýnýn belirtildiði bir belgedir.

[Makine](/Uretim/Makine.md "Makine") bir üretim tesisinde kullanýlan herhangi bir makineyi ifade eder, ürünün veya bileþenin üretiminde kullanýlan herhangi bir ekipman olabilir. 
Üretim makineleri, üretim hattýnda farklý iþlevlere sahip olabilir; 
Bazýlarý hammaddeleri iþleyebilir, bazýlarý montaj yapabilir, bazýlarý test edebilir ve diðerleri ise ambalajlama gibi son iþlemleri gerçekleþtirebilir.

[Operasyon](/Uretim/Operasyon.md "Operasyon") bir üretim sürecinin belirli bir aþamasýnda gerçekleþtirilen belirli bir faaliyettir. 
Operasyon, hammaddelerin iþlenmesi, parçalarýn montajý, ürünlerin test edilmesi gibi çeþitli iþlemleri içerebilir. 
Operasyonlar genellikle belirli bir ürün veya hizmetin üretimini tamamlamak için gerekli adýmlarý içeren bir operasyonel planýn parçasýdýr.

Reçeler, Makineler ve Operasyonlar hazýrlandýktan sonra ikinci aþama iþ emridir.

[Ýþ Emri](/Uretim/IsEmri.md "Ýþ Emri") bir iþin yapýlmasý için çalýþanlara veya birimlere verilen talimatlardýr. 
Ýþ emri bir iþin ne zaman, nerede, nasýl ve kim tarafýndan yapýlacaðýný belirtir.
Her bir operasyon ve ürünler(reçeteler) iþ emrinde aþamalý olarak yer almasý gerekmektedir.

Ýþ emirleri tamamlandýktan sonraki aþama Planlama aþamasýdýr.

[Planlama](/Uretim/Planlama.md "Planlama") iþletmenin belirli bir zaman diliminde hangi ürünleri ne zaman, ne kadar ve hangi kaynaklarla üreteceðini planlama sürecidir. 
Üretim faaliyetlerini etkin bir þekilde organize etmeyi ve kaynaklarýn en verimli þekilde kullanýlmasýný saðlar.
Ayný zamanda üretim yapýlýrken canlý takip etme olanaðýnýz mevcuttur. Ýþçi ne zaman ara verdi, ne zaman baþladý gibi süreçleri izleyebilirsiniz.

Üretim Aþamasýnda Canlý takip ve Sonradan manuel olarak iki þekilde giriþ yapýlmaktadýr. 
...
Otomatik planlama alternatif makineleri deðerlendirerek bir plan oluþturur. Kullanýma uygun kaç makine var ise operasyonu hepsini eþit þekilde daðýtýr. 
...
Üretim sürecinde iþletmenizin için en önemli detaylardan biri de maliyet hesaplamalarýdýr.
