...
Operasyon, bir ürünün üretim sürecindeki adýmlarý veya iþlemleri tanýmlar. 
Her operasyon, üretim sürecinde belirli bir görevin nasýl yapýlacaðýný açýklar.

- Reçeteye eklemek istediðiniz operasyonu seçin. Bu, belirli bir iþin veya iþlemin adýdýr (örneðin, kesme, montaj, boyama).
- Operasyonun nasýl yapýlacaðýný tanýmlayýn. Bu, gerekli makineler, kullanýlan malzemeler, iþlem süresi gibi bilgileri içerir.
- Operasyonlarýn doðru sýrayla yapýldýðýndan emin olun. Her adýmýn hangi sýrayla yapýlacaðýný belirleyin.
- Tüm bilgileri girdikten sonra deðiþiklikleri kaydedin.

## Reçete Operasyon Ekle / Düzenle (Öncesi-Sonrasý)

### Genel

**Operasyon** Yapýlacak operasyonu seçelim.
**Makine** Kullanýlacak makineyi seçelim.
...
**Bekleme Süresi** Sonraki operasyona baþlamadan önce beklenmesi gereken süreyi Vardiya cinsinden belirtiniz. 3 vardiya 1 gün olarak deðerlendirilir.
**Benzerlik** Bu Operasyonun yapýmýnda üretim þekli benzer olan reçeteleri gruplayarak daha verimli þekilde planlama yapabilirsiniz.
...
Operasyonu silme iþlemi, artýk kullanýlmayan veya yanlýþlýkla kaydedilmiþ bir operasyon girdisini sistemden kaldýrmak amacýyla yapýlýr.
