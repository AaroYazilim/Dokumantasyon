...
**Eriþim Linki :** [erp.aaro.com.tr/CekSenetBankadanTahsilEdildi?TipID=CekBankadanTahsilEdildi&](erp.aaro.com.tr/CekSenetBankadanTahsilEdildi?TipID=CekBankadanTahsilEdildi&)

### Ulaþým

- Sol sekmede Aaro kullanýcý bilgilerinin hemen altýnda yer alan arama motorundan "Çek" aratarak ulaþým saðlayabilirsiniz.
- Sol menüden ÇekSenet -> Hareket Oluþtur -> Çek Bankadan Tahsil Edildi üzerinden ulaþým saðlayabilirsiniz. 
- Sol menüden Banka -> Hareket Oluþtur -> Çek Bankadan Tahsil Edildi üzerinden ulaþým saðlayabilirsiniz. 

### Taným 

Çek Bankadan Tahsil Edildi iþlemi, bankaya tahsil edilmek üzere verilen bir çekin, ilgili banka tarafýndan baþarýyla tahsil edilmesi sürecini ifade eder. 
Bu iþlem, çekin üzerinde belirtilen tutarýn, çek sahibinin hesabýna geçmesi ve tahsilat iþleminin tamamlanmasý anlamýna gelir. 
Bu süreç, çekin bankaya teslim edilmesi, gerekli kontrollerin yapýlmasý ve çek tutarýnýn hesaba aktarýlmasý ile son bulur. 
Bankadan tahsil edilen çek, muhasebe kayýtlarýna alýnarak ilgili hesaplara iþlenir.
...
- **Alt Tip:** Alt hareket tipini belirtir. Ýþlemin belirli bir iþlem altýnda sýnýflandýrýlmasýný saðlayan alt hareket tipini belirtir. 
Bu, iþlemin farklý bir iþlem hareket türü içinde yer aldýðýný gösterir.
...
- Kullanýcýya özel sipariþ formu gibi farklý tasarýmlar yapýlabilir.
