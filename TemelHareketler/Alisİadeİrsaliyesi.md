...
- Alış iade irsaliyesinde kalemimiz stok, gelir gider, demirbaş olabilir. En başta ki kutucuktan seçim yapılabilir, sistem otomatik stok olarak getirir.
...
- İskonto: Alış iade irsaliyesinde kalem için iskonto oranını belirtir. Uyguladığımız iskonto var ise buraya oranı girebiliriz.
...
- Sağ üst köşede faturaya ait toplam fiyat kısımlarını içerir;
	...
	- Genel Toplam: Alış iade irsaliyesinin tüm kalemlerin tutarının toplamını belirtir.
...
Alış iade irsaliyemizde ekleme yapmak ya da herhangi bir düzeltme yapmak için kalem işaretini seçerek açılan ekranda düzenlemeleri yapabiliriz.
