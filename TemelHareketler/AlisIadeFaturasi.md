...
- Alış iade faturamızda kalemimiz stok, gelir gider, demirbaş olabilir. En başta ki kutucuktan seçim yapılabilir, sistem otomatik stok olarak getirir.
...
- Sağ üst köşede faturaya ait toplam fiyat kısımlarını içerir;
	...
	- Genel Toplam: Alış iade faturasının tüm kalemlerin tutarının toplamını belirtir.
...
Alış iade faturamızda ekleme yapmak ya da herhangi bir düzeltme yapmak için kalem işaretini seçerek açılan ekranda düzenlemeleri yapabiliriz.
