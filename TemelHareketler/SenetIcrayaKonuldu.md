...
# Senet Ýcraya Konuldu

**Eriþim Linki :** [erp.aaro.com.tr/CekSenetIcrayaKonuldu?TipID=SenetIcrayaKonuldu](https://erp.aaro.com.tr/CekSenetIcrayaKonuldu?TipID=SenetIcrayaKonuldu)

### Ulaþým

- Sol sekmede Aaro kullanýcý bilgilerinin hemen altýnda yer alan arama motorundan "senet" aratarak ulaþým saðlayabilirsiniz.
- Sol menüden ÇekSenet -> Hareket Oluþtur -> Senet -> Senet Ýcraya Konuldu þeklinde ulaþým saðlayabilirsiniz. 

### Taným 

Senet icraya konuldu ifadesi, bir senedin ödenmemesi durumunda alacaklýnýn yasal yollarla tahsilat iþlemi baþlatarak senedi icra takibine verdiðini belirtir. 
Bu iþlem, senedin zorunlu olarak tahsil edilmesi amacýyla yetkili icra dairesine teslim edilmesi anlamýna gelir.
...
- **Çek Senet Ekle:** Ýcraya verilen seneti seçelim.
