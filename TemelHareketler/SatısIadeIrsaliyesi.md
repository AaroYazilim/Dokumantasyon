...
# Satýþ Ýade Ýrsaliyesi

**Eriþim Linki :** [erp.aaro.com.tr/FaturaSatisIadeIrsaliyesi](erp.aaro.com.tr/FaturaSatisIadeIrsaliyesi)

### Ulaþým

- Sol sekmede Aaro kullanýcý bilgilerinin hemen altýnda yer alan arama motorundan "satýþ iade" aratarak ulaþým saðlayabilirsiniz.
- Sol menüden Musteri/Satici -> Hareket Oluþtur -> Satýþ ve Pazarlama -> Satýþ Ýade Ýrsaliyesi þeklinde ulaþým saðlayabilirsiniz. 
- Sol menüden Satýþ & Pazarlama -> Listeler -> Satýþ Ýade Ýrsaliyesi Listesi -> Yeni Hareket Ekle üzerinden ulaþým saðlayabilirsiniz. 

## Taným 

Satýþ iade irsaliyesi, müþterinin satýn aldýðý mal veya hizmeti iade etmesi durumunda düzenlenen belgedir. 
Bu irsaliye, iade edilen ürünlerin detaylarýný, miktarýný ve varsa iade nedenini içerir. 
Ayrýca, iade iþleminin muhasebe kayýtlarýna doðru bir þekilde yansýtýlmasý için kullanýlýr. 
Satýþ iade irsaliyesi, iþletmelerin stok ve muhasebe süreçlerini düzenli tutmalarýna yardýmcý olur.
...
**Teslim Tarihi:** Ýadenin yapýldýðý, yapýlacaðý tarihi girelim.

### Açýklamalar

- **Açýklamalar:** Ek açýklamalarý belirtir. Ýade nedeni burada belirtilebilir. [Açýklama](/TemelOzellikler/Aciklama.md "Açýklama")	
...
- Satýþ iade irsaliyemizde iade edilen stok, gelir gider, demirbaþ olabilir. En baþta ki kutucuktan seçim yapýlabilir, sistem otomatik stok olarak getirir.
- Kart Adý: Stok, demirbaþ ya da gelir gider satýþýný gerçekleþtireceðimiz kartý belirtir.
- Miktar: Ýade yapýlan ürünün stok miktarýný belirtir, bu alanýn doldurdurulmasý gerekmektedir.
...
- Satýþ iade irsaliyesinde 1 kalem belirtilecekse kaydet diyerek bir sonraki aþamaya geçebiliriz.
...
- Sað üst köþede faturaya ait toplam fiyat kýsýmlarýný içerir;
	...
	- Ýskonto Sonrasý: Satýþ iade irsaliyesinin KDV dahil fiyatýndan uygulanan iskonto tutarýný ifade eder.
	- KDV: Satýþ iade irsaliyesinin KDV oranýnýn karþýlýk geldiði tutarý ifade eder.
	- Genel Toplam: Satýþ iade irsaliyesinin tüm kalemlerin KDV dahil tutarýnýn toplamýný belirtir.

### Kalem Ekleme Ek Özellikler

- Yeni Stok Kalemi Ekle: Stok kalemi eklemek için burayý seçerek ekleme saðlayabilirsiniz.
- Yeni Gelirgider Kalemi Ekle: Gelir gider kalemi eklemek için burayý seçerek ekleme saðlayabilirsiniz.
- Yeni Demirbaþ Kalemi Ekle: Demirbaþ kalemi eklemek için burayý seçerek ekleme saðlayabilirsiniz.
...
- Sayfanýn sað üstünde bulunan yazýcý sembolü ile faturanýn çýktýsý alýnabilir. 
...
- Görev Oluþtur: Ýade iþlemi için görev oluþturup, kiþi atayabiliriz, açýklama, tarih bitiþ, hatýrlatma süresi, yönetici, kullanýcý, tamamlanma tipi, tekrar þekli bilgilerini ekleyerek görev tanýmlama iþlemimizi gerçekleþtirebiliriz.
