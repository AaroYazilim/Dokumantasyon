...
**Eriþim Linki :** [erp.aaro.com.tr/FaturaSatisIadeFaturasi](erp.aaro.com.tr/FaturaSatisIadeFaturasi)
...
- Sol menüden Musteri/Satici -> Hareket Oluþtur -> Satýþ Ýade Faturasý þeklinde ulaþým saðlayabilirsiniz. 
- Sol menüden Satýþ & Pazarlama -> Listeler -> Satýþ Ýade Faturasý Listesi -> Yeni Hareket Ekle üzerinden ulaþým saðlayabilirsiniz. 

## Taným 

Satýþ iade faturasý, müþterinin satýn aldýðý mal veya hizmeti geri iade etmesi durumunda düzenlenen bir faturadýr. 
Bu fatura, iade edilen ürün veya hizmetin bedelinin müþteriye geri ödenmesi veya borcunun düþülmesi için kullanýlýr. 
Ýadenin nedeni (örneðin, ürünün kusurlu olmasý, yanlýþ ürün gönderimi, müþteri memnuniyetsizliði vb.) fatura üzerinde açýklanmalýdýr.
Satýþ iade faturasý düzenlemek, muhasebe kayýtlarýnýn düzgün tutulmasý ve yasal gerekliliklerin yerine getirilmesi açýsýndan önemlidir.
...
- Satýþ iade faturamýzda iade edilen stok, gelir gider, demirbaþ olabilir. En baþta ki kutucuktan seçim yapýlabilir, sistem otomatik stok olarak getirir.
...
- Satýþ iade faturasýnda 1 kalem belirtilecekse kaydet diyerek bir sonraki aþamaya geçebiliriz.
...
- Sað üst köþede faturaya ait toplam fiyat kýsýmlarýný içerir;
	- Toplam: Satýþ iade faturasýnýn KDV hariç toplam tutarýný içerir.
	- Ýskonto Sonrasý: Satýþ iade faturasýnýn KDV dahil fiyatýndan uygulanan iskonto tutarýný ifade eder.
	- KDV: Satýþ iade faturasýnýn KDV oranýnýn karþýlýk geldiði tutarý ifade eder.
	- Genel Toplam: Satýþ iade faturasýnýn tüm kalemlerin KDV dahil tutarýnýn toplamýný belirtir.
...
- ÝrsalÝyeden Kalem Ekle: Ýrsaliyeden kalemleri seçerek buraya aktarým yapabiliriz.
