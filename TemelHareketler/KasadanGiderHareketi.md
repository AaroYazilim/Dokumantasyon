...
**Eriþim Linki :** [erp.aaro.com.tr/KasaAlacakDekontu](erp.aaro.com.tr/KasaAlacakDekontu)

## Ulaþým 

- Sol sekmede Aaro kullanýcý bilgilerinin hemen altýnda yer alan arama motorundan 'kasa gider' aratarak ulaþým saðlayabilirsiniz.
- Sol sekmede yer alan modüller kýsmýndan Kasa -> Hareket Oluþtur -> Kasadan Gider Hareketi þeklinde ulaþým saðlayabilirsiniz.

## Taným

Kasadan gider hareketi, bir iþletmenin kasa hesabýndan yapýlan mali çýkýþlarý temsil eder. 
Bu, çeþitli giderler, ödemeler veya diðer mali iþlemler nedeniyle nakit çýkýþýný ifade eder.
Giderler, genellikle faturalar, maaþ ödemeleri, hizmet bedelleri veya diðer mali yükümlülükler için kasadan nakit olarak ödenir.
...
Kasadan gider hareketleri, þirketin nakit akýþýný yönetmek ve mali durumunu izlemek için önemli bir unsurdur.
...
**Kasa:** Nakit ödemenin yapýldýðý kasayý ifade eder.

**Döviz:** Bu iþlemin çalýþtýðý döviz cinisini belirtir.

**Açýklama:** Kasa iþlemi için ek detaylar burada belirtilebilir. 
...
- Yeni Gelirgider Kalemi Ekle: Kasadan yapýlan gelir gider kalemi eklemek için burayý seçerek ekleme saðlayabilirsiniz.

- Kart Adý: Gelir gider kartýný belirtir.
- Miktar: Ýþlemi gerçekleþen giderin miktarýný belirtir, bu alanýn doldurdurulmasý gerekmektedir.
...
- Ýskonto: Giderimizin iskonto oranýný belirtir. Uygulanan iskonto var ise buraya oraný girebiliriz.
...
- Demirbaþ: Gider, bir demirbaþ için yapýlmýþ olup, hangi demirbaþa ait olduðunu belirtir.
- Masraf Merkezi: Giderin hangi birim veya departman için yapýldýðýný belirtir.
- Proje: Bu kalemin hangi projeye ait olduðunu belirtir.
- Sözleþme: Bu kalemin hangi sözleþmeye ait olduðunu gösterir.
- Proje: Bu kalemin hangi projeye ait olduðunu belirtir.

- Kasa hareketinde bir kalem belirtilecekse kaydet diyerek bir sonraki aþamaya geçebiliriz.
...
- Sað üst köþede faturaya ait toplam fiyat kýsýmlarýný içerir;
	- Toplam: Kasa hareketinin KDV hariç toplam tutarýný içerir.
	- Genel Toplam: Kasa hareketinin tüm kalemlerin KDV dahil tutarýnýn toplamýný belirtir.
...
- Kopyala: Kasa hareketini iþlemini kopyalamak için kullanýlýr.
...
- Görev Oluþtur: Kasa hareketi için görev oluþturup, kiþi atayabiliriz, açýklama, tarih bitiþ, hatýrlatma süresi, yönetici, kullanýcý, tamamlanma tipi, tekrar þekli bilgilerini ekleyerek görev tanýmlama iþlemimizi gerçekleþtirebiliriz.
