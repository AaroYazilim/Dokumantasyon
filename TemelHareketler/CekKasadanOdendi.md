...
**Eriþim Linki :** [erp.aaro.com.tr/CekSenetKasadanOdendi?TipID=CekKasadanOdendi](https://erp.aaro.com.tr/CekSenetKasadanOdendi?TipID=CekKasadanOdendi)

### Ulaþým

- Sol sekmede Aaro kullanýcý bilgilerinin hemen altýnda yer alan arama motorundan "çek" aratarak ulaþým saðlayabilirsiniz.
- Sol menüden ÇekSenet -> Hareket Oluþtur -> Çek Kasadan Ödendi þeklinde ulaþým saðlayabilirsiniz. 
- Sol menüden Kasa -> Hareket Oluþtur -> Çek Kasadan Ödendi þeklinde ulaþým saðlayabilirsiniz. 

### Taným 

Çek Kasadan Ödendi iþlemi, bir çekin ödeme aracý olarak kullanýlarak kasadan yapýlan bir ödeme iþlemini ifade eder. 
Bu durum, çekin bir borcun ödenmesi veya bir alým iþlemi için kullanýlmasý anlamýna gelir. 
Ödeme gerçekleþtikten sonra, çek tutarý kasa hesabýndan düþülür ve ilgili muhasebe kayýtlarýna iþlenir. 
Bu iþlem, hem çek hem de kasa hesaplarýnýn güncellenmesini saðlar.
...
- **Çek Senet Ekle:** Kasadan ödeme yapýlan çeki seçelim.
