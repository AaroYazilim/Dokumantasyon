...
# Çek Müþteriye Ýade Edildi

**Eriþim Linki :** [erp.aaro.com.tr/CekSenetCariyeIadeEdildi?TipID=CekCariyeIadeEdildi](https://erp.aaro.com.tr/CekSenetCariyeIadeEdildi?TipID=CekCariyeIadeEdildi)

### Ulaþým

- Sol sekmede Aaro kullanýcý bilgilerinin hemen altýnda yer alan arama motorundan "çek" aratarak ulaþým saðlayabilirsiniz.
- Sol menüden ÇekSenet -> Hareket Oluþtur -> Çek Müþteriye Ýade Edildi þeklinde ulaþým saðlayabilirsiniz. 
- Sol menüden Müþteri/Satýcý -> Hareket Oluþtur -> Çek -> Çek Müþteriye Ýade Edildi þeklinde ulaþým saðlayabilirsiniz. 

### Taným 

Çek Müþteriye Ýade Edildi iþlemi, bir müþteri tarafýndan teslim alýnan çekin, belirli bir nedenle müþteriye geri verilmesi sürecini ifade eder. 
Bu durum, çekin hatalý düzenlenmesi, anlaþmanýn iptali veya baþka bir nedenle tahsil edilememesi gibi durumlarda gerçekleþebilir. 
Ýade edilen çek, muhasebe kayýtlarýna iþlenir ve ilgili hesaplardan düþülür. 
Bu iþlem, çekin müþteri tarafýndan yeniden kullanýlmasýný veya baþka bir þekilde deðerlendirilmesini saðlar.
...
- **Çek Senet Ekle:** Müþteriye iade edilen çeki seçelim.
